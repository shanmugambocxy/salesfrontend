...
@Component({
  selector: 'app-saledeed-tobe-issued',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './saledeed-tobe-issued.component.html',
  styleUrl: './saledeed-tobe-issued.component.scss'
})
export class SaledeedTobeIssuedComponent {
  displayedColumns: string[] = ['sno', 'unitAccountNumber', 'schemeName', 'schemeType', 'unitNo', 'unittype', 'applicantName', 'allotedDate', 'totalDue', 'action'];
  ...
  getAllApplicationData() {
    this.propertyService.getScheduledDataSaleDeed("Executed").subscribe(
      (response: any) => {
