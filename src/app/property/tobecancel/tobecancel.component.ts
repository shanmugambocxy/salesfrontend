...
@Component({
  selector: 'app-tobecancel',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './tobecancel.component.html',
  styleUrl: './tobecancel.component.scss'
})
export class TobecancelComponent {

  displayedColumns: string[] = ['sno', 'unitAccountNumber', 'schemeName', 'schemeType', 'unitNo', 'unittype', 'applicantName', 'unitcost', 'paidsofar', 'duedate', 'echallanstatus', 'action'];
