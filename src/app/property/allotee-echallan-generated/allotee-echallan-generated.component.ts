...
@Component({
  selector: 'app-allotee-echallan-generated',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-echallan-generated.component.html',
  styleUrl: './allotee-echallan-generated.component.scss'
})
export class AlloteeEchallanGeneratedComponent {
  displayedColumns: string[] = ['sno', 'unitAccountNumber', 'schemeName', 'schemeType', 'unitNo', 'applicantName', 'challannumber', 'date', 'amount', 'action'];
  ...
  getAllApplicationData() {
    this.propertyService.getEchallanbycustomerid(this.customerID).subscribe(
      (response: any) => {
  ...
  viewAllApplicationsBySchemeId(element: any) {
    // this.router.navigate(['/employee/scheme/applications'], { queryParams: { schemeId: schemeId } });

    this.router.navigate(['/customer/allottee_echallan_view'], { queryParams: { id: element.id } });
