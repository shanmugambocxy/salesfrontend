...
@Component({
  selector: 'app-lcs-approved',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './lcs-approved.component.html',
  styleUrl: './lcs-approved.component.scss'
})
export class LcsApprovedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.generateLcsList("Approved").subscribe(
      (response: any) => {
