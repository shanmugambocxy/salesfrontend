...
@Component({
  selector: 'app-saledeed-executed',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './saledeed-executed.component.html',
  styleUrl: './saledeed-executed.component.scss'
})
export class SaledeedExecutedComponent {
