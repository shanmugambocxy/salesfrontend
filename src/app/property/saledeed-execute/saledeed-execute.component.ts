...
@Component({
  selector: 'app-saledeed-execute',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './saledeed-execute.component.html',
  styleUrl: './saledeed-execute.component.scss'
})
export class SaledeedExecuteComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getScheduledDataSaleDeed("Approved").subscribe(
      (response: any) => {
  ...
  executeSaleDeed(element: any) {

    const dialogRef = this.dialog.open(ConfirmationDialogComponent, {
      data: {
        title: 'Confirm Allotment',
        message: 'Are you sure you want to Execute this Sale Deed?'
      }
    });
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        let execute = {
          ...
          "id": element.id,
          "saleDeed": "Saledeed Path",
          "description": "Executed The Application",
          "executedStatus": "Executed",
          "handingOverStatus": "sale Deed Issued",
          "draftSaleDeedStatus": "sale Deed Issued"
        }



        this.propertyService.executeSaleDeed(execute).subscribe(res => {
          if (res) {
            this.getAllApplicationData()
          }
        })
