...
@Component({
  selector: 'app-aand-bcertificate-generated',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './aand-bcertificate-generated.component.html',
  styleUrl: './aand-bcertificate-generated.component.scss'
})
export class AandBcertificateGeneratedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getAandBGenerate("Generated").subscribe(
      (response: any) => {
