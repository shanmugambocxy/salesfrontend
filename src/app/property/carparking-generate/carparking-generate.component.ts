...
@Component({
  selector: 'app-carparking-generate',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './carparking-generate.component.html',
  styleUrl: './carparking-generate.component.scss'
})
export class CarparkingGenerateComponent {
