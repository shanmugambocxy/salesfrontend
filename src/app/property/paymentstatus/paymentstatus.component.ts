...
@Component({
  ...
  styleUrl: './paymentstatus.component.scss'
})
export class PaymentstatusComponent {
  displayedColumns: string[] = ['sno', 'unitAccountNumber', 'schemeName', 'schemeType', 'unitNo', 'unittype', 'applicantName', 'totaldemand', 'paidsofar', 'projectstatus', 'action'];
  ...
  viewAllPayment(element: any) {
    debugger
    this.router.navigate(['/employee/all-payments'], { queryParams: { applicationNo: element.unitData.unitAccountNumber, isedit: 1 } });
