...
@Component({
  selector: 'app-draftsaledeed-downloaded',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './draftsaledeed-downloaded.component.html',
  styleUrl: './draftsaledeed-downloaded.component.scss'
})
export class DraftsaledeedDownloadedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getDownlodedStatusDraftsaledeedBuyersRole("Yes").subscribe(
      (response: any) => {
