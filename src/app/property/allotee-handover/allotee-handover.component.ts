...
@Component({
  selector: 'app-allotee-handover',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-handover.component.html',
  styleUrl: './allotee-handover.component.scss'
})
export class AlloteeHandoverComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getGeneratedHandingOverByCustomerID(this.customerId, "handOvered", "True", "True").subscribe(
      (response: any) => {
