...
@Component({
  selector: 'app-lcs-approve',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './lcs-approve.component.html',
  styleUrl: './lcs-approve.component.scss'
})
export class LcsApproveComponent {
  ...
  getAllApplicationData() {
    this.propertyService.generateLcsList("Approve").subscribe(
      (response: any) => {
  ...
  approveLcs(id: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        let data = {
          "id": id,
          "sighnedLcsOrderPath": "ApprovePath",
          "description": "Your Signed LCS is Approved",
          "lcsStatus": "Approved",
          "handingOverStatus": "Ready"
        }
        this.propertyService.updateLCSStatusToApprove(data).subscribe(res => {
          if (res) {
            this.toast.showToast("success", "LCS Approved Successfully", "");
            this.getAllApplicationData();
          }
        })
      }
