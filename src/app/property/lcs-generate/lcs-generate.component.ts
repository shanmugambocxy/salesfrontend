...
@Component({
  selector: 'app-lcs-generate',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './lcs-generate.component.html',
  styleUrl: './lcs-generate.component.scss'
})
export class LcsGenerateComponent {
  ...
  getAllApplicationData() {
    this.propertyService.generateLcsList("Ready").subscribe(
      (response: any) => {
  ...
  generateLCS(id: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        let data = {
          "id": id,
          "lcsOrderPathWithoutSighn": "LCS",
          "lcsStatus": "Generated"
        }
        this.propertyService.updateLcsganerated(data).subscribe(res => {
          if (res) {
            this.getAllApplicationData();
            this.toast.showToast('success', "LCS Generated Successfully", '');
          }
        })
      }
    })
