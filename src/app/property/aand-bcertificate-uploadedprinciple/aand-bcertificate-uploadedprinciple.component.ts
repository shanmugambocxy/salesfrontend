...
@Component({
  selector: 'app-aand-bcertificate-uploadedprinciple',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './aand-bcertificate-uploadedprinciple.component.html',
  styleUrl: './aand-bcertificate-uploadedprinciple.component.scss'
})
export class AandBcertificateUploadedprincipleComponent {
  ...
  getAllApplicationData() {
    ...
    this.propertyService.getUploadInPrincipleLetterForBuyer("Upload").subscribe(
      (response: any) => {
