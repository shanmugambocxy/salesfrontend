...
@Component({
  selector: 'app-handedover',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './handedover.component.html',
  styleUrl: './handedover.component.scss'
})
export class HandedoverComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getGeneratedHandingOver(0, "handOvered", "True", "True").subscribe(
      (response: any) => {
