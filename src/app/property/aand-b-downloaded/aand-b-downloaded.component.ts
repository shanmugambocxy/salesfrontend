...
@Component({
  selector: 'app-aand-b-downloaded',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './aand-b-downloaded.component.html',
  styleUrl: './aand-b-downloaded.component.scss'
})
export class AandBDownloadedComponent {
  ...
  getAllApplicationData() {
    ...
    this.propertyService.getAandBDownloadedForBuyer("Yes").subscribe(
      (response: any) => {
