...
@Component({
  selector: 'app-saledeed-scheduled',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './saledeed-scheduled.component.html',
  styleUrl: './saledeed-scheduled.component.scss'
})
export class SaledeedScheduledComponent {
