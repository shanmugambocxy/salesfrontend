...
@Component({
  ...
  templateUrl: './allotmentorder.component.html',
  styleUrl: './allotmentorder.component.scss'
})
export class AllotmentorderComponent {

  displayedColumns: string[] = ['sno', 'unitAccountNumber', 'schemeName', 'schemeType', 'unitNo', 'unittype', 'applicantName', 'createdDateTime', 'modeofallottment'];
