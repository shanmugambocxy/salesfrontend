...
@Component({
  selector: 'app-lcs-generated',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './lcs-generated.component.html',
  styleUrl: './lcs-generated.component.scss'
})
export class LcsGeneratedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.generateLcsList("Generated").subscribe(
      (response: any) => {
