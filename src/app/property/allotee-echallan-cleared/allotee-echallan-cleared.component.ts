...
@Component({
  selector: 'app-allotee-echallan-cleared',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-echallan-cleared.component.html',
  styleUrl: './allotee-echallan-cleared.component.scss'
})
export class AlloteeEchallanClearedComponent {
  displayedColumns: string[] = ['sno', 'unitAccountNumber', 'schemeName', 'schemeType', 'unitNo', 'unittype', 'applicantName', 'challannumber', 'date', 'amount', 'action'];
