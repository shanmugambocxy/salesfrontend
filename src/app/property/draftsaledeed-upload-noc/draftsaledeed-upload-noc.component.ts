...
@Component({
  selector: 'app-draftsaledeed-upload-noc',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './draftsaledeed-upload-noc.component.html',
  styleUrl: './draftsaledeed-upload-noc.component.scss'
})
export class DraftsaledeedUploadNOCComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getNocuploadDataDraftsaledeed("Needed").subscribe(
      (response: any) => {
