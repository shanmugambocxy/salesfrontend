...
export class PaymentsComponent {
  ...
  displayedColumns: string[] = ['sno', 'PaymentDate', 'PaymentType', 'Amount', 'interestAmount', 'PaymentID', 'PaymentMethod', 'action'];
  isEdit: any;
  ...
  async sfsDetails() {
    ...
    let accountCode = accountCodeList.responseObject.filter((x: any) => x.code == "776");
    let accountDescription = accountCode.length > 0 ? accountCode[0].payType : ""
    let selffinanceData = [{ sno: 1, label: "1st", Description: "firstAmountDue", Date: this.payments.schemeData.firstDueDate, Dueamount: this.payments.unitData.firstAmountDue, Interest: 0, dueCollected: this.payments.unitData.firstDuePaidSoFar ? this.payments.unitData.firstDuePaidSoFar : 0, InterestCollected: this.payments.unitData.firstDueInterestPaidSoFar ? this.payments.unitData.firstDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.firstAmountDue) ? parseInt(this.payments.unitData.firstAmountDue) : 0) - (this.payments.unitData.firstDuePaidSoFar ? this.payments.unitData.firstDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    { sno: 2, label: "2nd", Description: "secondAmountDue", Date: this.payments.schemeData.secondDueDate, Dueamount: this.payments.unitData.secondAmountDue, Interest: 0, dueCollected: this.payments.unitData.secondDuePaidSoFar ? this.payments.unitData.secondDuePaidSoFar : 0, InterestCollected: this.payments.unitData.secondDueInterestPaidSoFar ? this.payments.unitData.secondDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.secondAmountDue) ? parseInt(this.payments.unitData.secondAmountDue) : 0) - (this.payments.unitData.secondDuePaidSoFar ? this.payments.unitData.secondDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    { sno: 3, label: "3rd", Description: "thirdAmountDue", Date: this.payments.schemeData.thirdDueDate, Dueamount: this.payments.unitData.thirdAmountDue, Interest: 0, dueCollected: this.payments.unitData.thirdDuePaidSoFar ? this.payments.unitData.thirdDuePaidSoFar : 0, InterestCollected: this.payments.unitData.thirdDueInterestPaidSoFar ? this.payments.unitData.thirdDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.thirdAmountDue) ? parseInt(this.payments.unitData.thirdAmountDue) : 0) - (this.payments.unitData.thirdDuePaidSoFar ? this.payments.unitData.thirdDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    { sno: 4, label: "4th", Description: "fourthAmountDue", Date: this.payments.schemeData.fourthDueDate, Dueamount: this.payments.unitData.fourthAmountDue, Interest: 0, dueCollected: this.payments.unitData.fourthDuePaidSoFar ? this.payments.unitData.fourthDuePaidSoFar : 0, InterestCollected: this.payments.unitData.fourthDueInterestPaidSoFar ? this.payments.unitData.fourthDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.fourthAmountDue) ? parseInt(this.payments.unitData.fourthAmountDue) : 0) - (this.payments.unitData.fourthDuePaidSoFar ? this.payments.unitData.fourthDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    { sno: 5, label: "5th", Description: "fifthAmountDue", Date: this.payments.schemeData.fifthDueDate, Dueamount: this.payments.unitData.fifthAmountDue, Interest: 0, dueCollected: this.payments.unitData.fifthDuePaidSoFar ? this.payments.unitData.fifthDuePaidSoFar : 0, InterestCollected: this.payments.unitData.fifthDueInterestPaidSoFar ? this.payments.unitData.fifthDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.fifthAmountDue) ? parseInt(this.payments.unitData.fifthAmountDue) : 0) - (this.payments.unitData.fifthDuePaidSoFar ? this.payments.unitData.fifthDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    { sno: 6, label: "6th", Description: "sixthAmountDue", Date: this.payments.schemeData.sixthDueDate, Dueamount: this.payments.unitData.sixthAmountDue, Interest: 0, dueCollected: this.payments.unitData.sixthDuePaidSoFar ? this.payments.unitData.sixthDuePaidSoFar : 0, InterestCollected: this.payments.unitData.sixthDueInterestPaidSoFar ? this.payments.unitData.sixthDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.sixthAmountDue) ? parseInt(this.payments.unitData.sixthAmountDue) : 0) - (this.payments.unitData.sixthDuePaidSoFar ? this.payments.unitData.sixthDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    ...
    { sno: 9, label: "9th", Description: "ninthAmountDue", Date: this.payments.schemeData.ninthDueDate, Dueamount: this.payments.unitData.ninthAmountDue, Interest: 0, dueCollected: this.payments.unitData.ninthDuePaidSoFar ? this.payments.unitData.ninthDuePaidSoFar : 0, InterestCollected: this.payments.unitData.ninthDueInterestPaidSoFar ? this.payments.unitData.ninthDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.ninthAmountDue) ? parseInt(this.payments.unitData.ninthAmountDue) : 0) - (this.payments.unitData.ninthDuePaidSoFar ? this.payments.unitData.ninthDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    { sno: 10, label: "10th", Description: "tenthAmountDue", Date: this.payments.schemeData.tenthDueDate, Dueamount: this.payments.unitData.tenthAmountDue, Interest: 0, dueCollected: this.payments.unitData.tenthDuePaidSoFar ? this.payments.unitData.tenthDuePaidSoFar : 0, InterestCollected: this.payments.unitData.tenthDueInterestPaidSoFar ? this.payments.unitData.tenthDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.tenthAmountDue) ? parseInt(this.payments.unitData.tenthAmountDue) : 0) - (this.payments.unitData.tenthDuePaidSoFar ? this.payments.unitData.tenthDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    { sno: 11, label: "11th", Description: "eleventhAmountDue", Date: this.payments.schemeData.eleventhDueDate, Dueamount: this.payments.unitData.eleventhAmountDue, Interest: 0, dueCollected: this.payments.unitData.eleventhDuePaidSoFar ? this.payments.unitData.eleventhDuePaidSoFar : 0, InterestCollected: this.payments.unitData.eleventhDueInterestPaidSoFar ? this.payments.unitData.eleventhDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.eleventhAmountDue) ? parseInt(this.payments.unitData.eleventhAmountDue) : 0) - (this.payments.unitData.eleventhDuePaidSoFar ? this.payments.unitData.eleventhDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
    ...
    { sno: 13, label: "13th", Description: "thirteenthAmountDue", Date: this.payments.schemeData.thirteenthDueDate, Dueamount: this.payments.unitData.thirteenthAmountDue, Interest: 0, dueCollected: this.payments.unitData.thirteenthDuePaidSoFar ? this.payments.unitData.thirteenthDuePaidSoFar : 0, InterestCollected: this.payments.unitData.thirteenthDueInterestPaidSoFar ? this.payments.unitData.thirteenthDueInterestPaidSoFar : 0, dueBalance: (parseInt(this.payments.unitData.thirteenthAmountDue) ? parseInt(this.payments.unitData.thirteenthAmountDue) : 0) - (this.payments.unitData.thirteenthDuePaidSoFar ? this.payments.unitData.thirteenthDuePaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, status: 'Pending', applicationId: this.applicationId, checked: false, isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription }]
    ...
    this.propertyService.findInterestForSfs(data).subscribe(res => {
      if (res) {
        ...
        //other demand
        //differencecost
        let differenceaccountCode = accountCodeList.responseObject.filter((x: any) => x.code == "776");
        let differenceaccountDescription = differenceaccountCode.length > 0 ? differenceaccountCode[0].payType : ""
        debugger
        //accountcode- scrunity
        let accountCode = accountCodeList.responseObject.filter((x: any) => x.code == "189");
        let scrunityFeesDescription = accountCode.length > 0 ? accountCode[0].payType : ""

        //accountcode- mainteneance charge
        let accountCodeMaintanance = accountCodeList.responseObject.filter((x: any) => x.code == "137");
        let maintenanceDescription = accountCodeMaintanance.length > 0 ? accountCodeMaintanance[0].payType : ""

        //accountcode- carparking 
        let accountCodecarparking = accountCodeList.responseObject.filter((x: any) => x.code == "190");
        let carparkingDescription = accountCodecarparking.length > 0 ? accountCodecarparking[0].payType : ""
        ...
        this.otherDemands = [
          { sno: 2, label: "Different Cost Due Interest", Description: "DifferentCostDueInterest", Date: this.payments?.unitData?.dueDateOfDifferenceCost, Dueamount: DifferenceCost ? DifferenceCost : '0', Interest: 0, dueCollected: this.payments.unitData.differentCostPaidSoFar, InterestCollected: this.payments.unitData.differentinCostInterestPaidSoFar, dueBalance: DifferenceCost - (this.payments.unitData.differentCostPaidSoFar ? this.payments.unitData.differentCostPaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, applicationId: this.applicationId, Status: "Pending", isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: differenceaccountDescription },
          { sno: 3, label: "GST", Description: "GST", Date: '', Dueamount: gst ? gst : '0', Interest: 0, dueCollected: this.payments.unitData.gstCostPaidSoFar, InterestCollected: 0, dueBalance: gst - (this.payments.unitData.gstCostPaidSoFar ? this.payments.unitData.gstCostPaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, applicationId: this.applicationId, Status: "Pending", isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: accountDescription },
          { sno: 4, label: "Maintenance Charges", Description: "Maintenance Charges", Date: this.payments?.unitData?.mcDemandUpTo, Dueamount: this.mcDemand ? this.mcDemand : '0', Interest: 0, dueCollected: this.payments.unitData.mcDemandPaidSoFar, InterestCollected: 0, dueBalance: mcDemandCost - (this.payments.unitData.mcDemandPaidSoFar ? this.payments.unitData.mcDemandPaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, applicationId: this.applicationId, Status: "Pending", isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "137", codeDescription: maintenanceDescription },
          { sno: 5, label: "Car Parking Demand", Description: "Car Parking Demand", Date: '', Dueamount: carParkingDemand ? carParkingDemand : '0', Interest: 0, dueCollected: this.payments.unitData.carParkingPaidSoFar, InterestCollected: 0, dueBalance: carParkingDemand - (this.payments.unitData.carParkingPaidSoFar ? this.payments.unitData.carParkingPaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, applicationId: this.applicationId, Status: "Pending", isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: carparkingDescription },
          { sno: 6, label: "Scrunity Fee", Description: "Scrunity Fee", Date: '', Dueamount: scrunityFees ? scrunityFees : '0', Interest: 0, dueCollected: this.payments.unitData.scrunityFeesPaidSoFar ? this.payments.unitData.scrunityFeesPaidSoFar : 0, InterestCollected: 0, dueBalance: scrunityFees - (this.payments.unitData.scrunityFeesPaidSoFar ? this.payments.unitData.scrunityFeesPaidSoFar : 0), interestBalance: 0, totalDueAmount: 0, applicationId: this.applicationId, Status: "Pending", isPartCollected: 0, isPartInterestCollected: 0, partPayment: false, isAvailable: false, code: "776", codeDescription: scrunityFeesDescription }
  ...
  pay(paymentType: any, cost: any) {
    ...
    dialogRef.afterClosed().subscribe(async result => {
      if (result) {
        ...
        let accountCodeList: any = [];
        accountCodeList = await this.propertyService.getAllUnitCode().toPromise()
        let accountCode = paymentType == "Unit Cost" ? "778" : paymentType == "Difference in cost" ? "778" : paymentType == "Maintenance Charges" ? "137" : paymentType == "Car Parking Demand" ? "190" : paymentType == "Scrunity" ? "189" : ""
        ...
        if (!this.pathRoute) {
          ...
          const data = [{
            ...
            "code": accountCode,
            "codeDescription": this.getDescription(accountCodeList, accountCode)
          }]
