...
@Component({
  selector: 'app-aand-bcertificate-generate',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './aand-bcertificate-generate.component.html',
  styleUrl: './aand-bcertificate-generate.component.scss'
})
export class AandBcertificateGenerateComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getAandBGenerate("Upload").subscribe(
      (response: any) => {
  ...
  generateAandB(element: any) {
    let data = {
      "id": element.id,
      "description": "Generated",
      "anbStatus": "Generated",
      "anBOrderPath": "generaate order path"
    }
    this.propertyService.updateAandBToGenerated(data).subscribe(res => {
      if (res) {
        this.getAllApplicationData();
