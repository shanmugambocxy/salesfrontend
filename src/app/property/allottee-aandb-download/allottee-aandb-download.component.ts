...
@Component({
  selector: 'app-allottee-aandb-download',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allottee-aandb-download.component.html',
  styleUrl: './allottee-aandb-download.component.scss'
})
export class AllotteeAandbDownloadComponent {
  ...
  downloadAandB(element: any) {
    let data = {
      "id": element.id,
      "anbApprovedStatus": "Yes"
    }

    this.propertyService.updateDownloadedAandB(data).subscribe(res => {
      if (res) {
        const pdfUrl =
