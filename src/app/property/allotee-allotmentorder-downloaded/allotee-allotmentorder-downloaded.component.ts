...
@Component({
  selector: 'app-allotee-allotmentorder-downloaded',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-allotmentorder-downloaded.component.html',
  styleUrl: './allotee-allotmentorder-downloaded.component.scss'
})
export class AlloteeAllotmentorderDownloadedComponent {
