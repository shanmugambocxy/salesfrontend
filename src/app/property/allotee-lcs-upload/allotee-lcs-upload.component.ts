...
@Component({
  selector: 'app-allotee-lcs-upload',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-lcs-upload.component.html',
  styleUrl: './allotee-lcs-upload.component.scss'
})
export class AlloteeLCSUploadComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getAllotteeLcsDownload("Downloaded", this.customerId).subscribe(
      (response: any) => {
  ...
  uploadLcs(id: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        ...
        let data = {
          "id": id,
          "lcsRequestLetterPath": "upload",
          "lcsStatus": "Approve"
        }
        this.propertyService.updateRequestLCStoApprove(data).subscribe(res => {
          if (res) {
            this.toast.showToast('success', "LCS Uploaded Successfully", "");
            this.getAllApplicationData();
          }
        })
