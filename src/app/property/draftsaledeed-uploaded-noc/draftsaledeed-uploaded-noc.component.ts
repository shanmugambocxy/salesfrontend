...
@Component({
  selector: 'app-draftsaledeed-uploaded-noc',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './draftsaledeed-uploaded-noc.component.html',
  styleUrl: './draftsaledeed-uploaded-noc.component.scss'
})
export class DraftsaledeedUploadedNOCComponent {
