...
@Component({
  selector: 'app-allotee-lcs-downloaded',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-lcs-downloaded.component.html',
  styleUrl: './allotee-lcs-downloaded.component.scss'
})
export class AlloteeLCSDownloadedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getAllotteeLcsDownload("Generated", this.customerId).subscribe(
      (response: any) => {
  ...
  downloadedLcs(id: any) {
    const dialogRef = this.dialog.open(ConfirmationDialogComponent, {
      data: {
        title: 'Confirm Allotment',
        message: 'After Download It will Move To Upload After Sign?'
      }
    });
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        let data = {
          "id": id,
          "lcsDownloadStatus": "Yes",
          "lcsStatus": "Downloaded"
        }
        this.propertyService.updateLcsAllotteeDownloaded(data).subscribe(res => {
          if (res) {
            // const a = document.createElement('a');
            // a.target = '_target';
            // a.href = 'https://www.orimi.com/pdf-test.pdf';
