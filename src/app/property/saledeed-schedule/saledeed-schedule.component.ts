...
@Component({
  selector: 'app-saledeed-schedule',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './saledeed-schedule.component.html',
  styleUrl: './saledeed-schedule.component.scss'
})
export class SaledeedScheduleComponent {
  displayedColumns: string[] = ['sno', 'unitAccountNumber', 'schemeName', 'schemeType', 'unitNo', 'unittype', 'applicantName', 'createdDateTime'];
  ...
  getAllApplicationData() {
    ...
    this.propertyService.getScheduleByOfficerSaleDeed("NotNeeded", "Uploded", "Ready").subscribe(
      (response: any) => {
