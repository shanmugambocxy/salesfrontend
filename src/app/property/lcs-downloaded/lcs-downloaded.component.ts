...
@Component({
  selector: 'app-lcs-downloaded',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './lcs-downloaded.component.html',
  styleUrl: './lcs-downloaded.component.scss'
})
export class LcsDownloadedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getDownloadedLcsForBuyer("Yes").subscribe(
      (response: any) => {
