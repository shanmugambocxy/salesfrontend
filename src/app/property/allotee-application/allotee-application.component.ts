...
@Component({
  selector: 'app-allotee-application',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-application.component.html',
  styleUrl: './allotee-application.component.scss'
})
export class AlloteeApplicationComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getApplicationbyCustomerIdAllottee(this.customerId).subscribe(
      (response: any) => {
