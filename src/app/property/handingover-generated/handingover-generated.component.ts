...
@Component({
  selector: 'app-handingover-generated',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './handingover-generated.component.html',
  styleUrl: './handingover-generated.component.scss'
})
export class HandingoverGeneratedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getGeneratedHandingOver(0, "Generated", "false", "false").subscribe(
      (response: any) => {
