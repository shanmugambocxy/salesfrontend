...
@Component({
  selector: 'app-draftsaledeed-generated',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './draftsaledeed-generated.component.html',
  styleUrl: './draftsaledeed-generated.component.scss'
})
export class DraftsaledeedGeneratedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getGenerateDraftSaleDeed(0, "Generated").subscribe(
      (response: any) => {
