...
@Component({
  selector: 'app-saledeed-issued',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './saledeed-issued.component.html',
  styleUrl: './saledeed-issued.component.scss'
})
export class SaledeedIssuedComponent {
  displayedColumns: string[] = ['sno', 'unitAccountNumber', 'schemeName', 'schemeType', 'unitNo', 'unittype', 'applicantName', 'appointmentDate', 'createdDateTime', 'action'];
