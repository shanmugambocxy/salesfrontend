...
@Component({
  selector: 'app-echallan-generated',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './echallan-generated.component.html',
  styleUrl: './echallan-generated.component.scss'
})
export class EchallanGeneratedComponent {
