...
@Component({
  selector: 'app-allotmentorder-download',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotmentorder-download.component.html',
  styleUrl: './allotmentorder-download.component.scss'
})
export class AllotmentorderDownloadComponent {
