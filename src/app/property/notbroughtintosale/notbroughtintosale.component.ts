...
@Component({
  selector: 'app-notbroughtintosale',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './notbroughtintosale.component.html',
  styleUrl: './notbroughtintosale.component.scss'
})
export class NotbroughtintosaleComponent {
