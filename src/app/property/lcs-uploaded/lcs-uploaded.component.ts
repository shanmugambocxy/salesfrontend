...
@Component({
  selector: 'app-lcs-uploaded',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './lcs-uploaded.component.html',
  styleUrl: './lcs-uploaded.component.scss'
})
export class LcsUploadedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getLcsUploadedStatusforBuyers("Yes").subscribe(
      (response: any) => {
