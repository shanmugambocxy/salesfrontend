...
@Component({
  selector: 'app-allotee-draftsale-uploaded',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-draftsale-uploaded.component.html',
  styleUrl: './allotee-draftsale-uploaded.component.scss'
})
export class AlloteeDraftsaleUploadedComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getNocuploadDataDraftsaledeed("uploaded").subscribe(
      (response: any) => {
