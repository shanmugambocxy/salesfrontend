...
@Component({
  selector: 'app-applicationinvitingfor-lot',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './applicationinvitingfor-lot.component.html',
  styleUrl: './applicationinvitingfor-lot.component.scss'
})
export class ApplicationinvitingforLOTComponent {
  displayedColumns: string[] = ['sno', 'schemecode', 'schemeName', 'schemeType', 'totalnos', 'unittype', 'modeofallottment'];
