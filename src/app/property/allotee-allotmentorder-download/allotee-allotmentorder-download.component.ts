...
@Component({
  selector: 'app-allotee-allotmentorder-download',
  standalone: true,
  imports: [SharedModule],
  templateUrl: './allotee-allotmentorder-download.component.html',
  styleUrl: './allotee-allotmentorder-download.component.scss'
})
export class AlloteeAllotmentorderDownloadComponent {
  ...
  getAllApplicationData() {
    this.propertyService.getAllotteeAllotmentOrder("Accept", this.customerId).subscribe(
      (response: any) => {
  ...
  downloadAllotmentOrder(element: any) {
    ...
    let data = {
      "id": element.id,
      "allottmentDownloadedStatus": "Yes"
    }
    this.propertyService.updateAllottmentDownloadedStatusForBuyers(data).subscribe(res => {
      if (res) {
        // const pdfUrl =
        //   "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf";
        const pdfUrl = element.sighnedAllotmentOrderPath;

        // const pdfUrl =
        //   "https://staging.safegold.com/display/sales-invoice/da771e90-aa8f-4147-bc7c-805b73bb1283";
        const pdfName = "allotmentOrder.pdf";
